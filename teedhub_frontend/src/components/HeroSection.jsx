      ...
      <div className="absolute inset-0 overflow-hidden">
        <style>{`
          @keyframes lavaBlob1 {
            ...
            75% { transform: translate(100px, 40px) scale(1.2); }
          ...
          @keyframes lavaBlob2 {
            ...
            75% { transform: translate(-50px, -100px) scale(1.15); }
            100% { transform: translate(0, 0) scale(1); }
          }
          @keyframes lavaBlob3 {
            0% { transform: translate(0, 0) scale(1); }
            25% { transform: translate(100px, 60px) scale(1.18); }
            50% { transform: translate(-70px, -80px) scale(0.88); }
          ...
          @keyframes lavaBlob4 {
            ...
            75% { transform: translate(-60px, 60px) scale(1.18); }
            100% { transform: translate(0, 0) scale(1); }
          }
          @keyframes lavaBlob5 {
            0% { transform: translate(0, 0) scale(1); }
            25% { transform: translate(70px, 100px) scale(1.15); }
        ...
        <div 
          ...
          style={{
            top: '10%', 
            left: '10%',
            background: 'radial-gradient(circle at 30% 30%, rgba(168, 85, 247, 0.45), rgba(168, 85, 247, 0.15) 50%, transparent 70%)',
            animation: 'lavaBlob1 15s cubic-bezier(0.4, 0.0, 0.2, 1) infinite',
            filter: 'blur(80px)',
        ...
        <div 
          ...
          style={{
            top: '60%', 
            right: '10%',
            background: 'radial-gradient(circle at 40% 40%, rgba(236, 72, 153, 0.45), rgba(236, 72, 153, 0.15) 50%, transparent 70%)',
            animation: 'lavaBlob2 18s cubic-bezier(0.4, 0.0, 0.2, 1) infinite',
            filter: 'blur(80px)',
            willChange: 'transform',
          }}
        />
        ...
        <div 
          ...
          style={{
            top: '40%', 
            left: '40%',
            background: 'radial-gradient(circle at 35% 35%, rgba(249, 115, 22, 0.5), rgba(249, 115, 22, 0.2) 50%, transparent 70%)',
            animation: 'lavaBlob3 20s cubic-bezier(0.4, 0.0, 0.2, 1) infinite',
            filter: 'blur(80px)',
            willChange: 'transform',
          }}
        />
        ...
        <div 
          ...
          style={{
            bottom: '10%', 
            left: '20%',
            background: 'radial-gradient(circle at 30% 30%, rgba(234, 179, 8, 0.5), rgba(234, 179, 8, 0.2) 50%, transparent 70%)',
            animation: 'lavaBlob4 17s cubic-bezier(0.4, 0.0, 0.2, 1) infinite',
            filter: 'blur(80px)',
            willChange: 'transform',
          }}
        />

        {/* Additional accent blobs for more fluidity */}
        <div 
          className="absolute w-[400px] h-[400px] rounded-full"
          style={{
            top: '20%', 
            right: '30%',
            background: 'radial-gradient(circle at 35% 35%, rgba(249, 115, 22, 0.4), rgba(249, 115, 22, 0.12) 50%, transparent 70%)',
            animation: 'lavaBlob5 16s cubic-bezier(0.4, 0.0, 0.2, 1) infinite',
            filter: 'blur(80px)',
            willChange: 'transform',
          }}
        />
